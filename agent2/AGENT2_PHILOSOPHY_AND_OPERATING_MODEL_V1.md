...
### 6. Decomposition is a first-class input

Agent2.0 should not stop at headline VIR direction.

It should use decomposition to judge:

- whether the signal is fundamental or mechanical
- whether the move is earnings-led, valuation-led, carry-driven, FX-driven, or otherwise concentrated
- whether a headline signal looks weaker once its driver mix is understood

Decomposition belongs in the core reasoning loop, not as a separate optional appendix.
...
Agent2.0 should not act like a retrieval bot.
...
- "what would change our view?" prompts

based on the combined evidence from:

- positions
- benchmark-relative active weights
- VIR
- algo
- decomposition
- internal history
...
Evidence should be sourced.
Questions and challenge statements should be reasoned.

### Good output examples

- "The fund remains materially underweight EM Asia despite four months of improving VIR."
- "The persistence of the underweight looks more like positioning inertia unless internal rationale still justifies the stance."
- "The signal improved, but decomposition suggests the move is mostly valuation-driven rather than earnings-led."
- "What specific risk still justifies maintaining this underweight despite sustained improvement in valuation and earnings signals?"
...
- knows the portfolio
- understands the driver mix behind the signal
